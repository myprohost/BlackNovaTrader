...
echo "        <dt style='padding:3px'><label for='password'>{$l_login_password}:</label></dt>\n";
echo "        <dd style='padding:3px'><input type='password' id='password' name='password' size='20' maxlength='40' value='' style='width:200px'></dd>\n";
